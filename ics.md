...
- [ ] 登入頁面按下關閉，應該要用動畫結束，原本動畫怎麼呈現，就相反著出去。
- [ ] 按下確認密碼欄位，畫面上移時，最上面的圖片應該要會動，增加使用者體驗。(參考https://github.com/Yalantis/PullToMakeFlight)
- [ ] 登入頁面的登入按鈕&註冊按鈕，在尚未輸入資料之前，按鈕的狀態是disable，輸入完正確要求後才變成enable。
---
### Feature
- [ ] 06/18 - 修改密碼功能
- [ ] 06/21 - touchID登入功能
