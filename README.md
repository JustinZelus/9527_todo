...
| ---------- | -----: | ----- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2019/06/21 |     JZ | 1.8.8| 1.首頁的menu可拖移交換位置，但前台api未寫，動畫暫時拿掉。 |
| 2019/06/17 |     JZ | 1.8.7| 1. 將物件加到我的最愛時，點選完會有動畫(參考無印良品app)。取消時也要有動畫。(例如星星碎掉)|
| 2019/06/17 |     JZ | 1.8.7| 1. 新版畫面2.0首頁。|
